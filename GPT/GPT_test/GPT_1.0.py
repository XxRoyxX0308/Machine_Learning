...
#pt、en
for en, en_labels in train_batches.take(1):
    break
...
transformer.save_weights('GPT.h5')
...
class Translator(tf.Module):
    ...
    def __call__(self, sentence, max_length=MAX_TOKENS):
        ...
        self.transformer(encoder_input, training=False)
...
print(translator(tf.constant('este é o primeiro livro que eu fiz.')).numpy())

reloaded = tf.saved_model.load('translator')

print(reloaded(tf.constant('este é o primeiro livro que eu fiz.')).numpy())
